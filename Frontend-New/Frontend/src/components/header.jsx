                ...
                {user && (
                  <>
                    <li className="nav-item dropdown">
                      ...
                      >
                        <li>
                          <Link to="/publicSantri" className="dropdown-item">
                            Data Santri
                          </Link>
                        </li>
                        <li>
                          <Link to="/publicMudaris" className="dropdown-item">
                            Data Mudaris
                          </Link>
                        </li>
                      </ul>
                    ...
                    <li className="nav-item dropdown">
                      ...
                      >
                        <li>
                          <Link to="/publicKamar" className="dropdown-item">
                            Informasi Kamar
                          </Link>
                        </li>
                        <li>
