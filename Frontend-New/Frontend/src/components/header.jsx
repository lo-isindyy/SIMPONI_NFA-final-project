                    ...
                    <nav className="navbar navbar-expand-lg py-2">
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav mx-auto">
                                ...
                                <li className="nav-item">
                                    <Link to="/publicDashboard" className="nav-link nav-link-animated px-3 fw-medium">Dashboard</Link>
                                </li>
                                ...
                                <li className="nav-item">
                                    <Link to="/publicPenjadwalan" className="nav-link nav-link-animated px-3 fw-medium">Penjadwalan</Link>
                                </li>
                                <li className="nav-item dropdown">
                                    <a 
                                        href="#" 
                                ...
                                <li className="nav-item">
                                    <Link to="/publicRuang-kelas" className="nav-link nav-link-animated px-3 fw-medium">Ruang Kelas</Link>
                                </li>
                                <li className="nav-item">
                                    <Link to="/publicPenilaian" className="nav-link nav-link-animated px-3 fw-medium">Penilaian</Link>
                                </li>
                            </ul>
