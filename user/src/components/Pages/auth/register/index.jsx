...
export default function Register() {
    ...
    const handleRegister = (e) => {
        ...
        alert(`Santri ${selectedSantri} telah berhasil melakukan Register! Silahkan lanjutkan untuk melakukan Login`);
        navigate("/login");
    };
        ...
        >
            ...
            <div className="mb-3">
                ...
                <option value="" disabled>
                    Cari Email Anda Disini!
                </option>
                {santriList.map((santri) => (
                    <option key={santri} value={santri}>
                    {santri}
                    </option>
                ))}
                </select>
