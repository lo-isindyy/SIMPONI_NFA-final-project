...
const Akun = () => {
    ...
    return (
        ...
        <nav
            ...
            style={{ backgroundColor: 'rgb(239, 244, 252)', backdropFilter: 'blur(10px)' }}
        >
        ...
        {showPasswordModal && (
            ...
            <div className="modal-dialog modal-dialog-centered">
                ...
                <div className="modal-body" style={{ backgroundColor: '#FAFAFA' }}>
                    <div className="mb-3">
                    <label className="form-label" style={{ color: '#1565C0' }}>Password Saat Ini</label>
                    <input
                        type="password"
                        className="form-control"
                    ...
                    <div className="mb-3">
                    <label className="form-label" style={{ color: '#2E7D32' }}>Password Baru</label>
                    <input
                        type="password"
                        className="form-control"
                    ...
                    <div className="mb-3">
                    <label className="form-label" style={{ color: '#6D4C41' }}>Konfirmasi Password Baru</label>
                    <input
                        type="password"
                        className="form-control"
                ...
                <div className="modal-footer" style={{ backgroundColor: '#FAFAFA', borderRadius: '0 0 20px 20px' }}>
                    <button
                    type="button"
                    className="btn"
                    onClick={() => setShowPasswordModal(false)}
